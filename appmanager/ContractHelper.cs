...
{ 
    public class ContractHelper : HelperBase
    {
        ...
        //private List<ContractData> contactcache = null;

        //public List<ContractData> GetContactList()
        //{
        //    if (contactcache == null)
        //    {
        //        contactcache = new List<ContractData>();
        //        manager.Navigator.GoToAgreement();
        //        ICollection<IWebElement> elements = driver.FindElements(By.Name("entry"));
        //        foreach (IWebElement element in elements)
        //        {
        //            var cells = element.FindElements(By.CssSelector("td"));
        //            contactcache.Add(new ContractData(cells[2].Text, cells[1].Text)
        //            {
